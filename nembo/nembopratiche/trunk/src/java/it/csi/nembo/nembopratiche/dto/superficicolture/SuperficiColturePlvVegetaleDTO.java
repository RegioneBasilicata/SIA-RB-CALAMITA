...
public class SuperficiColturePlvVegetaleDTO implements ILoggable
{
	...
	{
		return superficieUtilizzata != null ? NemboUtils.FORMAT.formatDecimal4(superficieUtilizzata) : "";
	}
	
	public String getProduzioneQFormatted()
	{
		return produzioneQ != null ? NemboUtils.FORMAT.formatDecimal2(produzioneQ) : "";
	}
	
	public String getGiornateLavPerSupUtilFormatted()
	{
		return giornateLavPerSupUtil != null ? NemboUtils.FORMAT.formatDecimal2(giornateLavPerSupUtil) : "";
	}
	
	public String getUfFormatted()
	{
		return uf != null ? NemboUtils.FORMAT.formatDecimal2(uf) : "";
	}
	
	public String getReimpieghiQFormatted()
	{
		return reimpieghiQ != null ? NemboUtils.FORMAT.formatDecimal2(reimpieghiQ) : "";
	}
	
	public String getReimpieghiUfFormatted()
	{
		return reimpieghiUf != null ? NemboUtils.FORMAT.formatDecimal2(reimpieghiUf) : "";
	}
	
	public String getPlvFormatted()
	{
		return plv != null ? NemboUtils.FORMAT.formatDecimal2(plv) : "" ;
	}
