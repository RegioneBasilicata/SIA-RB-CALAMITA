...
@Controller
@NemboSecurity(value = "CU-NEMBO-165-D", controllo = NemboSecurity.Controllo.PROCEDIMENTO_OGGETTO)
@RequestMapping(value = "/cunembo165d")
public class CUNEMBO165DGestioneControlliAmministrativiDettaglio
    extends BaseController
{
      ...
      throws InternalUnexpectedException
  {
    ...
    // NEMBO_D_OGGETTO.TIPO_PAGAMENTO_SIGOP = 'SALDO')
    ProcedimentoOggetto po = getProcedimentoOggettoFromRequest(request);
    if (NemboConstants.TIPO_PAGAMENTO_SIGOP.SALDO
    ...
    model.addAttribute("flagEstratta", NemboUtils.STRING
