...
public class AllevamentiDTO implements ILoggable
{
	...
	{
		return NemboUtils.FORMAT.formatDecimal2(giornateLavorative);
	}
	...
	{
		return NemboUtils.FORMAT.formatDecimal2(unitaForaggere);
	}
	...
	{
		return NemboUtils.FORMAT.formatDecimal2(pesoVivoMedio);
	}
	...
	{
		return NemboUtils.FORMAT.formatDecimal2(giornateLavorativeMedie);
	}
