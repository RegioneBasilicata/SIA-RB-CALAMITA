...
public class VerbaleIstruttoriaAnticipoParziale extends Stampa
{
  ...
  protected void generaXML(XMLStreamWriter writer, long idProcedimentoOggetto, IQuadroEJB quadroEJB, String cuName) throws Exception
  {
    ...
    writeFragment(NemboConstants.QUADRO.CODICE.DATI_ANTICIPO, writer, quadroEJB, procedimentoOggetto, cuName);
  ...
  {
    return "verbaleIstruttoriaAnticipo-PN";
  }
  ...
  {
    return "/psr20/rp-01/psrpratiche/templates/verbaleIstruttoriaAnticipo-PN.xdp";
  }
