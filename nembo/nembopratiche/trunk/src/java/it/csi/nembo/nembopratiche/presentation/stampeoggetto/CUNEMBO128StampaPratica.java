...
public class CUNEMBO128StampaPratica extends StampaController
{
  @RequestMapping(value = "/cunembo128/stampa")
  public ResponseEntity<byte[]> stampa(HttpSession session) throws Exception
  {
    return stampaByCUName(getIdProcedimentoOggetto(session),
        CUNEMBO128StampaPratica.class.getAnnotation(NemboSecurity.class)
            .value());
  }
}
