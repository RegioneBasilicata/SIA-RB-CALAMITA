...
@Controller
@NemboSecurity(value = "CU-NEMBO-246", controllo = NemboSecurity.Controllo.PROCEDIMENTO_OGGETTO)
public class CUNEMBO246GeneraStampaLetteraIstruttoriaAnticipo
    extends StampaController
{
  @RequestMapping(value = "/cunembo246/stampa")
  public ResponseEntity<byte[]> stampa(HttpSession session) throws Exception
  {
    return stampaByCUName(getIdProcedimentoOggetto(session),
        CUNEMBO246GeneraStampaLetteraIstruttoriaAnticipo.class
