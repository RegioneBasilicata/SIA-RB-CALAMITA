...
@Controller
@NemboSecurity(value = "CU-NEMBO-291-D", controllo = NemboSecurity.Controllo.PROCEDIMENTO_OGGETTO)
@RequestMapping(value = "/cunembo291d")
public class CUNEMBO291DControlloExPost extends BaseController
{
