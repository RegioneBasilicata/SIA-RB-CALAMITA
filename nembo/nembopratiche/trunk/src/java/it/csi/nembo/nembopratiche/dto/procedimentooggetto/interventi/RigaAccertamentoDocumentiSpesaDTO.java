...
public class RigaAccertamentoDocumentiSpesaDTO implements ILoggable
{
  ...
  public String getImportoRendicontatoCorrente()
  {
    ...
    return NemboUtils.FORMAT.formatGenericNumber(importoRendicontato, 2,
        true, false);
  }
  ...
  public String getImportoDaRendicontareStr()
  {
    return (importoDaRendicontare != null
        && importoDaRendicontare.compareTo(BigDecimal.ZERO) != 0)
            ? "&euro; "
                + NemboUtils.FORMAT.formatCurrency(importoDaRendicontare)
            : "";
  }
  ...
  {
    return NemboUtils.NUMBERS.getBigDecimal(importoAccertato);
  }
  ...
  {
    this.importoAccertato = NemboUtils.FORMAT
        .formatGenericNumber(importoAccertato, 2, true, false);
  }

  public BigDecimal getImportoNonRiconosciutoBD()
  {
    return NemboUtils.NUMBERS.getBigDecimal(importoNonRiconosciuto);
  }
  ...
  {
    this.importoNonRiconosciuto = NemboUtils.FORMAT
        .formatGenericNumber(importoNonRiconosciuto, 2, true, false);
  }

  public BigDecimal getImportoDisponibileBD()
  {
    return NemboUtils.NUMBERS.getBigDecimal(importoDisponibile);
  }
  ...
  {
    this.importoDisponibile = NemboUtils.FORMAT
        .formatGenericNumber(importoDisponibile, 2, true, false);
  }

  public BigDecimal getImportoCalcoloContributoBD()
  {
    return NemboUtils.NUMBERS.getBigDecimal(importoCalcoloContributo);
  }
  ...
  {
    this.importoCalcoloContributo = NemboUtils.FORMAT
