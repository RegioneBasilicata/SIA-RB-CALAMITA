...
@Controller
@NemboSecurity(value = "CU-NEMBO20-167-I", controllo = NemboSecurity.Controllo.PROCEDIMENTO_OGGETTO)
@RequestMapping(value = "/cuNEMBO20167i")
public class CUNEMBO20167IInserisciInvestimenti extends Inserisci
{
  @Override
