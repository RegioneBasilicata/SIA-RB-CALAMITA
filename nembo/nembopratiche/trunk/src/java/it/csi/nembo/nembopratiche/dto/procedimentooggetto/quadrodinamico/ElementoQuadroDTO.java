...
public class ElementoQuadroDTO implements ILoggable
{
  ...
  {
    return NemboConstants.FLAGS.SI.equals(flagObbligatorio);
  }
  ...
  {
    return NemboConstants.QUADRO_DINAMICO.TIPO_DATO.STR
        .equals(codiceTipoDato);
  }

  public boolean isTipoMST()
  {
    return NemboConstants.QUADRO_DINAMICO.TIPO_DATO.MST
        .equals(codiceTipoDato);
  }

  public boolean isTipoDTA()
  {
    return NemboConstants.QUADRO_DINAMICO.TIPO_DATO.DTA
        .equals(codiceTipoDato);
  }

  public boolean isTipoNUM()
  {
    return NemboConstants.QUADRO_DINAMICO.TIPO_DATO.NUM
        .equals(codiceTipoDato);
  }

  public boolean isTipoEUR()
  {
    return NemboConstants.QUADRO_DINAMICO.TIPO_DATO.EUR
        .equals(codiceTipoDato);
  }

  public boolean isTipoPCT()
  {
    return NemboConstants.QUADRO_DINAMICO.TIPO_DATO.PCT
        .equals(codiceTipoDato);
  }

  public boolean isTipoCMB()
  {
    return NemboConstants.QUADRO_DINAMICO.TIPO_DATO.CMB
        .equals(codiceTipoDato);
  }

  public boolean isTipoRBT()
  {
    return NemboConstants.QUADRO_DINAMICO.TIPO_DATO.RBT
        .equals(codiceTipoDato);
  }

  public boolean isTipoCBT()
  {
    return NemboConstants.QUADRO_DINAMICO.TIPO_DATO.CBT
        .equals(codiceTipoDato);
  }

  public boolean isTipoLST()
  {
    return NemboConstants.QUADRO_DINAMICO.TIPO_DATO.LST
        .equals(codiceTipoDato);
  }

  public boolean isTipoTXT()
  {
    return NemboConstants.QUADRO_DINAMICO.TIPO_DATO.TXT
        .equals(codiceTipoDato);
  }

  public boolean isTipoDTQ()
  {
    return NemboConstants.QUADRO_DINAMICO.TIPO_DATO.DTQ
        .equals(codiceTipoDato);
  }

  public boolean isTipoDTF()
  {
    return NemboConstants.QUADRO_DINAMICO.TIPO_DATO.DTF
        .equals(codiceTipoDato);
  }

  public boolean isTipoNU0()
  {
    return NemboConstants.QUADRO_DINAMICO.TIPO_DATO.NU0
        .equals(codiceTipoDato);
  }

  public boolean isTipoANN()
  {
    return NemboConstants.QUADRO_DINAMICO.TIPO_DATO.ANN
        .equals(codiceTipoDato);
  }

  public boolean isTipoNUQ()
  {
    return NemboConstants.QUADRO_DINAMICO.TIPO_DATO.NUQ
        .equals(codiceTipoDato);
  }

  public boolean isTipoTIT()
  {
    return NemboConstants.QUADRO_DINAMICO.TIPO_DATO.TIT
        .equals(codiceTipoDato);
  }

  public boolean isTipoSTM()
  {
    return NemboConstants.QUADRO_DINAMICO.TIPO_DATO.STM
        .equals(codiceTipoDato);
  }

  public boolean isTipoHTM()
  {
    return NemboConstants.QUADRO_DINAMICO.TIPO_DATO.HTM
        .equals(codiceTipoDato);
  }
  ...
  {
    return NemboConstants.FLAGS.SI.equals(flagProtetto);
  }
}
