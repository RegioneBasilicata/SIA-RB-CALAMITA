...
@Controller
@NemboSecurity(value = "CU-NEMBO-133-M", controllo = NemboSecurity.Controllo.PROCEDIMENTO_OGGETTO)
@RequestMapping(value = "/cunembo133m")
public class CUNEMBO133MModificaInterventi extends Modifica
{
  @Override
