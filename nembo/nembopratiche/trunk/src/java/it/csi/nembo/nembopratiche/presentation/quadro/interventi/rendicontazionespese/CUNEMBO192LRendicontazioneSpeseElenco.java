...
@Controller
@NemboSecurity(value = "CU-NEMBO-192-L", controllo = NemboSecurity.Controllo.PROCEDIMENTO_OGGETTO)
@RequestMapping(value = "/cunembo192l")
public class CUNEMBO192LRendicontazioneSpeseElenco
