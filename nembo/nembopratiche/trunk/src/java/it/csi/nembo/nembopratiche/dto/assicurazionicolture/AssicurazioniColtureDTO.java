...
public class AssicurazioniColtureDTO implements ILoggable
{
	...
	{
		return NemboUtils.FORMAT.formatDecimal2(importoPremio);
	}
	...
	{
		return NemboUtils.FORMAT.formatDecimal2(importoAssicurato);
	}
	...
	{
		return NemboUtils.FORMAT.formatDecimal2(importoRimborso);
	}
