...
public class TrasmissioneMassivaDAO extends BaseDAO
{
  ...
  public void initializeDAO() throws NamingException
  {
    DataSource datasource = (DataSource) InitialContext
        .doLookup("java:/nembopratiche/jdbc/nembopraticheTxDS");
      ...
      throws InternalUnexpectedException
  {
    ...
    try
    {
      final String QUERY_CLOSED_ITER = " UPDATE                                                   \n"
          + "   NEMBO_T_ITER_PROCEDIMENTO_OGGE                         \n"
          + " SET                                                      \n"
      ...
      throws InternalUnexpectedException
  {
    ...
    final String QUERY = " SELECT                                                 \n"
        ...
        + "     FROM                                               \n"
        + "       NEMBO_T_PROCEDIM_OGGETTO_STAMP POS                \n"
        + "     WHERE                                              \n"
      ...
      throws InternalUnexpectedException
  {
    ...
    final String QUERY = " SELECT                                         \n"
        ...
        + "   DESC_ANOMALIA                                \n"
        + " FROM                                           \n"
        + "   NEMBO_T_PROCEDIM_OGGETTO_STAMP                \n"
        + " WHERE                                          \n"
      ...
      throws InternalUnexpectedException
  {
    ...
    final String QUERY = " INSERT                                                         \n"
        ...
        + "       :ID_STATO_STAMPA,                                        \n"
        + "       ID_PROCEDIMENTO_OGGETTO,                                 \n"
        + "       SEQ_NEMBO_T_PROCEDIM_OGGET_STA.NEXTVAL,                  \n"
        + "       ID_OGGETTO_ICONA,                                        \n"
        + "       ID_BANDO_OGGETTO,                                        \n"
        + "       :EXT_ID_UTENTE_AGGIORNAMENTO,                            \n"
        + "       :EXT_ID_DOCUMENTO_INDEX,                                 \n"
