...
public class SuperficiColtureDettaglioPsrDTO implements ILoggable
{
	...
	{
		return NemboUtils.FORMAT.formatDecimal2(produzioneHaMedia);
	}
	...
	{
		return NemboUtils.FORMAT.formatGenericNumber(giornateLavorate, 1, true, true);
	}
	...
	{
		return NemboUtils.FORMAT.formatGenericNumber(giornateLavorateMedie, 1, true, true);
	}	
	...
	{
		return NemboUtils.FORMAT.formatDecimal2(qliReimpiegati);
	}	
	...
	{
		return NemboUtils.FORMAT.formatGenericNumber(ufReimpiegate, 0, false, true);
	}		
	...
	{
		return NemboUtils.FORMAT.formatDecimal2(prezzoMedio);
	}	
	...
	{
		return NemboUtils.FORMAT.formatDecimal2(plvTotQ);
	}
	...
	{
		return NemboUtils.FORMAT.formatDecimal2(plvTotQCalc);
	}
	...
	{
		return NemboUtils.FORMAT.formatDecimal2(prodTotale);
	}
	...
	{
		return NemboUtils.FORMAT.formatDecimal2(prodTotaleCalc);
	}
	...
	{
		return NemboUtils.FORMAT.formatDecimal2(giornateLavorativeTot);
	}	
	...
	{
		return NemboUtils.FORMAT.formatDecimal2(giornateLavorativeTotCalc);
	}
	...
	{
		return NemboUtils.FORMAT.formatDecimal2(ufTot);
	}
	...
	{
		return NemboUtils.FORMAT.formatDecimal2(ufTotCalc);
	}
	...
	{
		return NemboUtils.FORMAT.formatDecimal2(plvTotDich);
	}
	...
	{
		return NemboUtils.FORMAT.formatDecimal2(plvTotDichCalc);
	}
