...
public class QuadroContiCorrenti extends Fragment
{
  ...
  {
    ContoCorrenteEstesoDTO contoCorrente = quadroEJB.getContoCorrente(procedimentoOggetto.getIdProcedimentoOggetto(), procedimentoOggetto.getDataFine());
    ...
    if (contoCorrente != null)
    {
      ...
      writeTag(writer, "NumeroContoCorrente", contoCorrente.getNumeroContoCorrente());
