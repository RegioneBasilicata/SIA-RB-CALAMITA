    ...
    try
    {
      ...
      SELECT.append(
          " NEMBO_D_STATO_OGGETTO SO,                                  	\n"
              ...
              // NOTE : CONDIZIONE TOLTA PER TOBECONFIG
      ...
      if (!GenericValidator.isBlankOrNull(vo.getIdentificativo()))
      {
        ...
        logger.debug("-- vo.getIdentificativo().trim().toUpperCase() ="+vo.getIdentificativo().trim().toUpperCase());
      }
      if (!GenericValidator.isBlankOrNull(vo.getCuaa()))
      {
        parameterSource.addValue("CUAA", vo.getCuaa().trim().toUpperCase(),
            Types.VARCHAR);
        logger.debug("-- vo.getCuaa().trim().toUpperCase() ="+vo.getCuaa().trim().toUpperCase());
      }
      if (!GenericValidator.isBlankOrNull(vo.getCuaaProcedimenti()))
      {
        ...
        logger.debug("-- vo.getCuaaProcedimenti().trim().toUpperCase() ="+vo.getCuaaProcedimenti().trim().toUpperCase());
      }
      ...
      if (vo.getIstanzaDataA() != null)
      {
        parameterSource.addValue("DATA_ISTANZA_A", vo.getIstanzaDataA(),
            Types.DATE);
        logger.debug("-- vo.getIstanzaDataA() ="+vo.getIstanzaDataA());
      }
      ...
      if (vo.getIstanzaDataDa() != null)
      {
        parameterSource.addValue("DATA_ISTANZA_DA", vo.getIstanzaDataDa(),
            Types.DATE);
        logger.debug("-- vo.getIstanzaDataA() ="+vo.getIstanzaDataDa());
      }
      ...
      if (!GenericValidator.isBlankOrNull(vo.getPiva()))
      {
        ...
        logger.debug("-- vo.getPiva().trim().toUpperCase() ="+vo.getPiva().trim().toUpperCase());
      }
      if (!GenericValidator.isBlankOrNull(vo.getProvSedeLegale()))
      {
        parameterSource.addValue("SIGLA_PROVINCIA",
            vo.getProvSedeLegale().trim().toUpperCase(), Types.VARCHAR);
        logger.debug("-- vo.getProvSedeLegale().trim().toUpperCase() ="+vo.getProvSedeLegale().trim().toUpperCase());
      }
      if (!GenericValidator.isBlankOrNull(vo.getComuneSedeLegale()))
      {
        parameterSource.addValue("DESCRIZIONE_COMUNE",
            vo.getComuneSedeLegale().trim().toUpperCase(), Types.VARCHAR);
        logger.debug("-- vo.getComuneSedeLegale().trim().toUpperCase() ="+vo.getComuneSedeLegale().trim().toUpperCase());
      }
      if (utenteAbilitazioni.getRuolo().isUtenteIntermediario())
      {
        parameterSource.addValue("ID_INTERMEDIARIO", utenteAbilitazioni
            ...
            Types.NUMERIC);
        logger.debug("-- utenteAbilitazioni.getEnteAppartenenza().getIntermediario().getIdIntermediario() ="+utenteAbilitazioni.getEnteAppartenenza().getIntermediario().getIdIntermediario());
      }
      else
        if (isBeneficiario(utenteAbilitazioni))
        {
          parameterSource.addValue("CODICE_FISCALE",
              ...
              Types.VARCHAR);
          logger.debug("-- utenteAbilitazioni.getCodiceFiscale().trim().toUpperCase() ="+utenteAbilitazioni.getCodiceFiscale().trim().toUpperCase());
        }
      ...
      if (!GenericValidator.isBlankOrNull(vo.getDenominazione()))
      {
        parameterSource.addValue("DENOMINAZIONE",
            ...
            Types.VARCHAR);
        logger.debug("-- vo.getDenominazione() ="+vo.getDenominazione());
      }

      parameterSource.addValue("ATTORE",
          NemboUtils.PAPUASERV.getFirstCodiceAttore(utenteAbilitazioni),
          Types.VARCHAR);
      logger.debug("-- NemboUtils.PAPUASERV.getFirstCodiceAttore(utenteAbilitazioni) ="+NemboUtils.PAPUASERV.getFirstCodiceAttore(utenteAbilitazioni));
     
      parameterSource.addValue("ID_PROCEDIMENTO_AGRICOLO",
              utenteAbilitazioni.getIdProcedimento(),
              Types.NUMERIC);
      logger.debug("-- utenteAbilitazioni.getIdProcedimento() ="+utenteAbilitazioni.getIdProcedimento());
                
      logger.debug("-- query searchIdProcedimenti ="+SELECT);
