...
@Controller
@NemboSecurity(value = "CU-NEMBO-255-DI", controllo = NemboSecurity.Controllo.PROCEDIMENTO_OGGETTO)
@RequestMapping(value = "/cunembo255di")
public class CUNEMBO255DIDettaglioRendicontazioneSuperficiIstruttore
    extends BaseController
{
  ...
  {
    return NemboUtils.NUMBERS.nvl(bd).add(NemboUtils.NUMBERS.nvl(bd2),
        MathContext.DECIMAL128);
  }
}