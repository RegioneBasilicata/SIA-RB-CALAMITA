...
@Controller
@NemboSecurity(value = "CU-NEMBO-243", controllo = NemboSecurity.Controllo.PROCEDIMENTO_OGGETTO)
public class CUNEMBO243GeneraStampaVerbaleIstruttoriaAnticipo
    extends StampaController
{
  @RequestMapping(value = "/cunembo243/stampa")
  public ResponseEntity<byte[]> stampa(HttpSession session) throws Exception
  {
    return stampaByCUName(getIdProcedimentoOggetto(session),
        CUNEMBO243GeneraStampaVerbaleIstruttoriaAnticipo.class
