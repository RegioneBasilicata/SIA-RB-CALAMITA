...
@Controller
@NemboSecurity(value = "CU-NEMBO-133-Z", controllo = NemboSecurity.Controllo.PROCEDIMENTO_OGGETTO)
@RequestMapping(value = "/cunembo133z")
public class CUNEMBO133ZLocalizzazioneInterventi extends Localizza
{
  @Override
