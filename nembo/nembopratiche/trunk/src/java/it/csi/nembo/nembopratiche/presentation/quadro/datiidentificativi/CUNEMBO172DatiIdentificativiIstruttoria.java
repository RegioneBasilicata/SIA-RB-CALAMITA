...
@Controller
@RequestMapping("/cunembo172")
@NemboSecurity(value = "CU-NEMBO-172", controllo = NemboSecurity.Controllo.PROCEDIMENTO_OGGETTO)
public class CUNEMBO172DatiIdentificativiIstruttoria extends BaseController
{
  @Autowired
