...
import it.csi.nembo.nembopratiche.integration.QuadroDinamicoDAO;
...
public class QuadroDinamicoEJB extends NemboAbstractEJB<QuadroDinamicoDAO>
      ...
      throws InternalUnexpectedException
  {
    ...
    if (idDatiComuniElemQuadro == null)
    {
      idDatiComuniElemQuadro = dao.insertDatiComuniElemQuadro(
          idProcedimentoOggetto, idQuadro, numProgressivoRecord);
      tipoOperazione = NemboConstants.QUADRO_DINAMICO.TIPO_OPERAZIONE.INSERISCI;
    }
    else
    {
      dao.delete("NEMBO_T_DATO_ELEMENTO_QUADRO", "ID_DATI_COMUNI_ELEM_QUADRO",
          idDatiComuniElemQuadro);
      tipoOperazione = NemboConstants.QUADRO_DINAMICO.TIPO_OPERAZIONE.MODIFICA;
    }
    ...
    if (idDatiComuniElemQuadro != null)
    {
      ...
      if (!GenericValidator.isBlankOrNull(istruzSqlPostSalvataggio))
      {
        errorMessage = dao.executeIstruzSqlPostSalvataggio(
            ...
            NemboConstants.QUADRO_DINAMICO.TIPO_OPERAZIONE.ELIMINA,
            logOperationDTO.getExtIdUtenteAggiornamento());
        if (errorMessage != null)
        {
          return errorMessage;
      ...
      dao.delete("NEMBO_T_DATO_ELEMENTO_QUADRO", "ID_DATI_COMUNI_ELEM_QUADRO",
          idDatiComuniElemQuadro);
      dao.delete("NEMBO_T_DATI_COMUNI_ELEM_QUADR",
