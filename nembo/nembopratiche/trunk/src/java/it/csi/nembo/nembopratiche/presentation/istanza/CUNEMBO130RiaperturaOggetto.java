...
@Controller
@NemboSecurity(value = "CU-NEMBO-130", controllo = NemboSecurity.Controllo.PROCEDIMENTO_OGGETTO_CHIUSO)
@RequestMapping("/cunembo130")
public class CUNEMBO130RiaperturaOggetto extends BaseController
{
      ...
      throws InternalUnexpectedException
  {
    ...
    if(NemboUtils.VALIDATION.isEsitoOggettoNonRiapribile(po.getCodiceEsito()))
    {
      ...
      throws InternalUnexpectedException
  {
    ...
    if (msgErrore == null)
    {
      model.addAttribute("url", "../cunembo130/riepilogo.do");
  ...
  @NemboSecurity(value = "CU-NEMBO-130", controllo = NemboSecurity.Controllo.NESSUNO)
