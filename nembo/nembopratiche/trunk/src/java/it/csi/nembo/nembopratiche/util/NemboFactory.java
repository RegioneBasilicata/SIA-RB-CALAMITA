...
public class NemboFactory
{
  protected static IQuadroEJB   quadroEJB = null;
  protected static final Logger logger    = Logger
      .getLogger(NemboConstants.LOGGIN.LOGGER_NAME + ".util");
  static
  {
    try
    {
    ...
    {
      logger.fatal(
          "[NemboFactory statick block] Errore nel reperimento dell'ejb Quadro",
          e);
    }
  }
  ...
  {
    return NemboUtils.STRING.nvl(quadroEJB
  ...
  public static final ProcedimentoOggetto getProcedimentoOggetto(
      HttpServletRequest request,
      INemboAbstractEJB ejb) throws InternalUnexpectedException
  {
