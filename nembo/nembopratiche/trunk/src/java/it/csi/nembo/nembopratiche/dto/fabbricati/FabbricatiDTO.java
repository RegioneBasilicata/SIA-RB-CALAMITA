package it.csi.nembo.nembopratiche.dto.fabbricati;
...
public class FabbricatiDTO implements ILoggable
{
	...
	{
		return NemboUtils.FORMAT.formatDecimal4(superficie);
	}
	...
	{
		return NemboUtils.FORMAT.formatDecimal4(dimensione) + " " + unitaMisuraTipologiaFabbr;
	}
	...
	{
		return NemboUtils.DATE.formatDate(dataInizioValFabbr);
	}
	...
	public String getDataFineValFabbrFormatted()
	{
		...
		{
			return NemboUtils.DATE.formatDate(dataFineValFabbr);
		}
		else
		{
			return "";
	...
	{
		return NemboUtils.FORMAT.formatDecimal2(larghezza);
	}
	
	public String getLunghezzaFormatted()
	{
		return NemboUtils.FORMAT.formatDecimal2(lunghezza);
	}
	
	public String getAltezzaFormatted()
	{
		return NemboUtils.FORMAT.formatDecimal2(altezza);
	}
