...
@Controller
@NemboSecurity(value = "CU-NEMBO-231-I", controllo = NemboSecurity.Controllo.PROCEDIMENTO_OGGETTO)
@RequestMapping("cunembo231i")
public class CUNEMBO231IDataFineLavori extends BaseController
{
