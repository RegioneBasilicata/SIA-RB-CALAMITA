...
@Controller
@NemboSecurity(value = "CU-NEMBO-244", controllo = NemboSecurity.Controllo.PROCEDIMENTO_OGGETTO)
public class CUNEMBO244GeneraStampaVerbaleIstruttoriaSaldo
    extends StampaController
{
  @RequestMapping(value = "/cunembo244/stampa")
  public ResponseEntity<byte[]> stampa(HttpSession session) throws Exception
  {
    return stampaByCUName(getIdProcedimentoOggetto(session),
        CUNEMBO244GeneraStampaVerbaleIstruttoriaSaldo.class
