package it.csi.nembo.nembopratiche.dto.procedimentooggetto.stampa;
...
public class ProcedimOggettoStampaDTO implements ILoggable
{
  ...
  protected String flagStampaPresente;
  ...
  public String getFlagStampaPresente() {
	return flagStampaPresente;
}

public void setFlagStampaPresente(String flagStampaPresente) {
	this.flagStampaPresente = flagStampaPresente;
}
