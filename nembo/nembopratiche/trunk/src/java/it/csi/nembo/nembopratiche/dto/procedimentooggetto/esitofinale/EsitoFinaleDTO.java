package it.csi.nembo.nembopratiche.dto.procedimentooggetto.esitofinale;
...
public class EsitoFinaleDTO implements ILoggable
{
  ...
  public String getPrescrizioniHtml()
  {
    return (prescrizioni != null)
        ? NemboUtils.STRING.safeHTMLText(prescrizioni) : null;
  }
  ...
  {
    return (note != null) ? NemboUtils.STRING.safeHTMLText(note) : null;
  }
  ...
  {
    return NemboUtils.DATE.formatDate(dataAtto);
  }
