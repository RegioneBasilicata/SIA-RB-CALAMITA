...
@Controller
@NemboSecurity(value = "CU-NEMBO-303-L", controllo = NemboSecurity.Controllo.PROCEDIMENTO_OGGETTO)
@RequestMapping("/cunembo303l")
public class CUNEMBO303LVisualizzaFabbricatiController extends BaseController
{
	@Autowired
