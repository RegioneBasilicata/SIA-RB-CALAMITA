package it.csi.nembo.nembopratiche.dto.procedimentooggetto.anticipo;
...
public class DatiAnticipo extends DatiAnticipoModificaDTO
{
  ...
  public BigDecimal getImportoContributoAnticipabile()
  {
    ...
    if (ripartizioneAnticipo != null)
    {
      ...
      {
        if (NemboConstants.FLAGS.SI.equals(r.getFlagAnticipo()))
        {
          importoContributoAnticipabile = NemboUtils.NUMBERS
  ...
  public BigDecimal getTotaleImportoInvestimento()
  {
    ...
    if (ripartizioneAnticipo != null)
    {
      for (RigaAnticipoLivello r : ripartizioneAnticipo)
      {
        totale = NemboUtils.NUMBERS.add(totale, r.getImportoInvestimento());
      }
    }
    return totale;
  }
  ...
  public BigDecimal getTotaleImportoAmmesso()
  {
    ...
    if (ripartizioneAnticipo != null)
    {
      for (RigaAnticipoLivello r : ripartizioneAnticipo)
      {
        totale = NemboUtils.NUMBERS.add(totale, r.getImportoAmmesso());
      }
    }
    return totale;
  }
  ...
  public BigDecimal getTotaleContributoConcesso()
  {
    ...
    if (ripartizioneAnticipo != null)
    {
      for (RigaAnticipoLivello r : ripartizioneAnticipo)
      {
        totale = NemboUtils.NUMBERS.add(totale, r.getImportoContributo());
      }
    }
    return totale;
  }
  ...
  public BigDecimal getTotaleImportoAnticipo()
  {
    ...
    if (ripartizioneAnticipo != null)
    {
      for (RigaAnticipoLivello r : ripartizioneAnticipo)
      {
        totale = NemboUtils.NUMBERS.add(totale, r.getImportoAnticipo());
      }
    }
    return totale;
  }
