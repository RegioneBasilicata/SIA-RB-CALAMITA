...
public class SigopSystemException_Exception extends Exception
{
  ...
  private it.csi.nembo.nembopratiche.integration.ws.sigop.sigopserv.SigopSystemException sigopSystemException;
  ...
  public SigopSystemException_Exception(String message,
      it.csi.nembo.nembopratiche.integration.ws.sigop.sigopserv.SigopSystemException sigopSystemException)
  {
    super(message);
  ...
  public it.csi.nembo.nembopratiche.integration.ws.sigop.sigopserv.SigopSystemException getFaultInfo()
  {
