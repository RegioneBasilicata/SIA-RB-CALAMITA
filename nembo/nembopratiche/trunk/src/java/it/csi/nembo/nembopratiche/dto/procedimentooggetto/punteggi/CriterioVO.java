package it.csi.nembo.nembopratiche.dto.procedimentooggetto.punteggi;
...
public class CriterioVO implements ILoggable
{
  ...
  public String getDescPrincipioSelezioneHtml()
  {
    return (descPrincipioSelezione != null)
        ? NemboUtils.STRING.safeHTMLText(descPrincipioSelezione) : null;
  }
  ...
  {
    return (codice != null) ? NemboUtils.STRING.safeHTMLText(codice) : null;
  }
  ...
  public String getCriterioSelezioneHtml()
  {
    return (criterioSelezione != null)
        ? NemboUtils.STRING.safeHTMLText(criterioSelezione) : null;
  }
  ...
  {
    return (specifiche != null) ? NemboUtils.STRING.safeHTMLText(specifiche)
        : null;
  }
