package it.csi.nembo.nembopratiche.dto.dannicolture;
...
public class DanniColtureDTO implements ILoggable
{
	...
	public String getProdPerdutaFormatted()
	{
		...
		if(prodPerduta != null)
		{
			return NemboUtils.FORMAT.formatDecimal2(prodPerduta);
		}
		else
		{
			return "0,00";
	...
	public String getPercDannoFormatted()
	{
		...
		if(percDanno != null)
		{
			return NemboUtils.FORMAT.formatDecimal2(percDanno) + "%";
		}
		else
		{
			return "0,00%";
	...
	public String getContrMaxConcedibileFormatted()
	{
		...
		{
			return NemboUtils.FORMAT.formatDecimal2(contrMaxConcedibile);
		}
		return null;
	}
	...
	public String getContrErogabileFormatted()
	{
		...
		{
			return NemboUtils.FORMAT.formatDecimal2(contrErogabile);
		}
		return null;
	}
