...
@Controller
@NemboSecurity(value = "CU-NEMBO-200", controllo = NemboSecurity.Controllo.PROCEDIMENTO_OGGETTO)
public class CUNEMBO200GeneraStampaLetteraAmmissioneFinanziamento
    extends StampaController
{
  @RequestMapping(value = "/cunembo200/stampa")
  public ResponseEntity<byte[]> stampa(HttpSession session) throws Exception
  {
    return stampaByCUName(getIdProcedimentoOggetto(session),
        CUNEMBO200GeneraStampaLetteraAmmissioneFinanziamento.class
