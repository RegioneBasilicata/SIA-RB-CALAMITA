		...
		<m:panel id="panelPianoGraficoHome">
			...
			<div id="msgAttesa" class="stdMessagePanel stdMessageLoad" style="margin-top:10em;margin-bottom:5em;display: none">			
		         <div class="alert alert-info">
		          <p>Attenzione: il sistema sta effettuando il consolidamento della Domanda Grafica; l'operazione potrebbe richiedere alcuni secondi.</p>
		         </div>
				...
				<form action="" method="post" id="myForm">
					<div class="stdMessagePanel">
						<div id="messaggio" class="alert alert-warning">
							<p>Procedere con il consolidamento della domanda grafica?</p>
						</div>
					</div>
