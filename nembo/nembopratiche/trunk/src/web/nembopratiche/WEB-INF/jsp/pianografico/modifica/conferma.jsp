...
<body>
	...
	<p:breadcrumbs cdu="CU-NEMBO-285-A" />
	<p:messaggistica />
	<p:testata cu="CU-NEMBO-285-A" />
		...
		<m:panel id="panelPianoGraficoHome">
			...
			<div id="msgAttesa" class="stdMessagePanel stdMessageLoad" style="margin-top:10em;margin-bottom:5em;display: none">			
		         <div class="alert alert-info">
		          <p>Attenzione: il sistema sta effettuando l'acquisizione dei dati per la Domanda Grafica; l'operazione potrebbe richiedere alcuni secondi.</p>
		         </div>
				...
				<form action="" method="post" id="myForm">
					<div class="stdMessagePanel">
						<div id="messaggio" class="alert alert-warning">
							<p>Procedere con l'acquisizione dei dati per la domanda grafica?</p>
						</div>
					</div>
