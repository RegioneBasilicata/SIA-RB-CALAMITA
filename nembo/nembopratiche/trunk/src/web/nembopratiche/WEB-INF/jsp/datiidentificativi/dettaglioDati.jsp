...
<body>
	...
	<p:breadcrumbs cdu="CU-NEMBO-103" />
	<p:messaggistica />
	<p:testata cu="CU-NEMBO-103" />

	<div class="container-fluid" id="content">
		<b:panel>
			<p:abilitazione-azione codiceQuadro="DID" codiceAzione="MODIFICA">
				<div class="puls-group" style="margin-top: 1em; margin-bottom: 2em">
					<div class="pull-left">
						<button type="button" onclick="forwardToPage('../cunembo105/index.do');" class="btn  btn-primary">modifica</button>
					</div>
					<br class="clear" />
				</div>
			...
			<b:panel title="Indicatori" id="indicatori">
				<table summary="Bando" style="margin-top: 4px" class="myovertable table table-hover table-condensed table-bordered">
					...
					<tbody>
						...
						<tr>
							<th>Settore di produzione prevalente dell'investimento</th>
							<td>${azienda.sottosettoreOteHtml}</td>
						</tr>
					</tbody>
				</table>
			</b:panel>
