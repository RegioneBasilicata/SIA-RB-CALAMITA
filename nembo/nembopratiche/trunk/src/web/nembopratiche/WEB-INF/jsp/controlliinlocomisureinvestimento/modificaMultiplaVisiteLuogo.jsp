					...
					<tbody>
						<c:forEach items="${visite}" var="v">
							<tr>
								...
								<td style="vertical-align: middle"><m:selectchoice id="idTecnico_${v.idVisitaLuogo}" name="idTecnico_${v.idVisitaLuogo}"
										preferRequestValues="${preferRequest}" list="${tecnici}" selectedValue="${v.extIdTecnico}" listChoice="${ufficiZona}" selectedChoice="STESSO_UFFICIO"/></td>
