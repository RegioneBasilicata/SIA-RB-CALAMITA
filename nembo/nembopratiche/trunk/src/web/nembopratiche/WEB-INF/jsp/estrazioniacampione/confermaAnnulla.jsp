        ...
        <div class="row">
            <div class="moduletable">
                <ul class="breadcrumb">
				  ...
				  <li class="active">Annullamento</li>
				</ul>
            </div>
        </div>           
    </div>
<p:messaggistica/>
	...
	<div class="container-fluid" id="content">
		<br />
		<div class="alert alert-warning" role="alert">Proseguendo il sistema effettuer&agrave; l'annullamento dell'estrazione a campione. Continuare?</div>
		
		<div class="form-group">
			<m:textarea name="motivo" id="motivo" preferRequestValues="${prfRequestValues}" rows="4" label="Motivo annullamento *" ></m:textarea>
		</div>
