...
<p:utente/>
		<p:breadcrumbs cdu="CU-NEMBO-106-I"/>
		<p:messaggistica/><p:testata cu="CU-NEMBO-106-I" />
		
		<div class="container-fluid" id="content" style="margin-bottom: 3em">
		<m:panel id="panelImpegni">
			...
			<p:abilitazione-azione codiceQuadro="IMPEG" codiceAzione="MODIFICA">
				<div class="puls-group" style="margin-top:1em;margin-bottom: 2em">
					<div class="pull-left">
						<button type="button" onclick="forwardToPage('../cunembo107i/index.do');" class="btn  btn-primary">modifica</button>
					</div>
					<br class="clear" />
				</div>
