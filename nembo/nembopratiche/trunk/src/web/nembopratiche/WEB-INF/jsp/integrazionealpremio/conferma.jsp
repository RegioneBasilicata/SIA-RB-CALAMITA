...
<div class="container-fluid">
	...
	<div class="form-group puls-group" style="margin-top: 1.5em">
		<div class="col-sm-12">
			...
			<button type="button" name="conferma" id="conferma" class="btn btn-primary pull-right" onclick="changeInPleaseWait('${messaggioAttendere}');$('#myForm').submit();">Prosegui</button>
		</div>
	</div>
</div>	
