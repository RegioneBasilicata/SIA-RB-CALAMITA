<form action="eliminabeneficiario_${idFgTipologia}_${idLivello}.do" method="post" class="form-horizontal" id="confermaEliminaForm" style="margin-top: 1em">
	${message}
	<input type="hidden" id="idFgTipologia" value="${idFgTipologia}">
