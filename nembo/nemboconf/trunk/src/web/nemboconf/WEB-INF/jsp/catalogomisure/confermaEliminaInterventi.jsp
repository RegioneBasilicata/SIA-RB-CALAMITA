<form action="confermaeliminaintervento_${idDescrizioneIntervento}_${idLivello}.do" method="post" class="form-horizontal" id="confermaEliminaForm" style="margin-top: 1em" >
	${message}
	<input type="hidden" id="idDescrizioneIntervento" value="${idDescrizioneIntervento}">
