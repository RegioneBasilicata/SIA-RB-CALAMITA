  ...
  <p:utente/>
		...
		<div class="row">
			<div class="moduletable">
				<ul class="breadcrumb">
					...
					<li><a href="dettaglio_${idLivello}.do">dettaglio settori di produzione</a> <span class="divider">/</span></li>
					<li class="active">inserisci settori di produzione</li>
				</ul>
			</div>
		</div>
	</div> 
	...
	<p:messaggistica/><div class="container-fluid" id="content" style="margin-bottom:3em">
		<form:form action="" modelAttribute="" id="mainForm" method="post" class="form-horizontal" style="margin-top:2em">
			<h3>Inserisci settori di produzione</h3>
			<div class="stdMessageLoad">			
		        <div class="alert alert-info">
		         <p>Caricamento elenco settori di produzione in corso...</p> 
		        </div>
		    </div>
			...
			<div id="dual-list-box" class="form-group row">
		    	<select id= "dualListSelect" style="display: none" multiple="multiple" data-title="Settori"  data-source="loadSettori_${idLivello}.json"
		                data-value="idSettore" data-text="descrizione" data-sourceselected="loadSettoriSelezionati_${idLivello}.json"
 		         ></select>
		    </div>
