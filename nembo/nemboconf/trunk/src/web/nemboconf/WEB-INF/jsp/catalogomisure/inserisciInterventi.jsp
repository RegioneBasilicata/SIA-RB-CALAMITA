		...
		<div class="row">
			<div class="moduletable">
				<ul class="breadcrumb">
					...
					<li><a href="dettaglio_${idLivello}.do">dettaglio interventi</a> <span class="divider">/</span></li>
	...
	<p:messaggistica/><div class="container-fluid" id="content" style="margin-bottom:3em">
		<form:form action="" modelAttribute="" id="mainForm" method="post" class="form-horizontal" style="margin-top:2em">
			...
			<div id="dual-list-box" class="form-group row">
		    	<select style="display: none" multiple="multiple" data-title="Interventi" data-source="loadInterventi_${idLivello}.json"
		                data-value="idDescrizioneIntervento" data-text="descrizione" 
		                data-sourceselected="loadInterventiSelezionati_${idLivello}.json"
		                 data-addcombo="true" data-labelcombo="Tipo intervento" 
		                 data-addcombomaster="true" data-labelcombomaster="Categoria"
		                 data-labelfilter="Intervento"></select>
		    </div>
